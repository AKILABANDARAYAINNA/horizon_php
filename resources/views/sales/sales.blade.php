...
<main class="bg-gray-100">
    <section class="container mx-auto my-16">
        <h2 class="text-3xl font-bold text-center text-gray-700 mb-8">Properties for Sale</h2>
        ...
        @else
            <p class="text-center text-gray-700">No properties available for sale at the moment.</p>
        @endif
    </section>
</main>
@endsection
